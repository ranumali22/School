...
//         fetch(localurl + "student_main_exam/" + school_id + "/" + session_id + "/" + class_id + "/" + subject_id + "/" + subject_head_id + "/" + test_id)
//             .then(res => res.json())
//             .then(data => {
...
//                             onChange={(e) => setForm({ ...form, subject_head_id: e.target.value })}
//                             options={[
...
//             <h2 className="text-3xl font-bold mb-8 text-gray-800">Exam Results</h2>           <div className="flex flex-col md:flex-row sm:flex-row md:items-center justify-start gap-6 mb-8">
...
//                     <thead>
//                         <tr className="bg-white text-center border-b-2 border-slate-100">
//                             <th
//                                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">#</th>

//                             <th onClick={() => handleSort("exam")}
//                                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">Exam ⬍</th>
//                             <th onClick={() => handleSort("class")}
//                                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">Class ⬍</th>
...
//                                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">Subject ⬍</th>
//                             <th
//                                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">Action</th>
//                             {/* <th
...
//                                     <td className="px-2 md:px-4 py-2 whitespace-nowrap">{item.test}</td>
//                                     <td className="px-2 md:px-4 py-2 whitespace-nowrap">{item.classsection}</td>
//                                     <td className="px-2 md:px-4 py-2 whitespace-nowrap">{item.subject}</td>
