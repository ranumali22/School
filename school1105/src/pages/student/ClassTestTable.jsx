...
// import ClassTestMarks from "./AddClassTest";
...
//     fetch(localurl + "student_class_test/" + school_id + "/" + session_id + "/" + class_id + "/" + subject_id + "/" + subject_head_id + "/" + test_id)
//       .then(res => res.json())
//       .then(data => {
...
//       <h2 className="text-3xl font-bold mb-8 text-gray-800">Class Test Results</h2>      <div className="flex flex-col md:flex-row sm:flex-row md:items-center justify-start gap-6 mb-8">
//         {/* Center Search */}
...
//               <th onClick={() => handleSort("test")}
//                 className="px-2 md:px-3 py-2 font-medium text-[14px] whitespace-nowrap cursor-pointer">Test ⬍</th>
